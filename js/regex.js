...
function executaRegex(valores) {
	...
	var objetoRegex  = new RegExp(textoPattern, 'g'); //objeto JavaScript RegExp recebendo como parâmetros um padrão e uma flag, que nesse caso foi o g que significa global: todos os resultados encontrados serão retornados
